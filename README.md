...
A growing portfolio of data driven inventory manager analysis projects using real business scenarios.
...
## Dataset
All projects use a Lagos/Abuja Supermarket sales dataset (LEAD SUPERMARKET)
